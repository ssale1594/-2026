...
> ## ⚠️ هذا التقرير أصبح لقطة تاريخية — الكود تغيّر بعده
> كل النقاط الحرجة هنا (اعتماد البائع، لوحة التدقيق، الاستفتاءات، انتهاء
> الاشتراك، البريد) **تم إصلاحها بالكود بتاريخ 2026-08-21/22** بهجرات
> `00000000000054` إلى `00000000000059`. **الإصلاحات بالكود لكنها لم تُطبَّق
> على قاعدة الإنتاج بعد** — راجع [NEXT.md](NEXT.md) قسم "🔴 مطلوب من صاحب
> المشروع" للصق الهجرات بمحرر Supabase. بعد اللصق، اعتبر القسمين 2-3 أدناه
> (فجوة region_id باقية كما هي — راجع IDEAS.md) والقسم 5 (checklist الإطلاق)
> منجزين إلا ما ذُكر صراحة أنه مؤجّل خارجيًا (Tap، مزوّد البريد).
> للحالة الحالية الكاملة والأفكار الجديدة المضافة، ابدأ من [NEXT.md](NEXT.md).
